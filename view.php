...
if (isset($_GET['delete'])) {
    ...
    $condition = ['ID' => $id];
    $deleteMsg = delete_data($link, "requests", $condition, $usrData, $usr);
...
if (isset($_GET['approve'])) {
    $id = validate($_GET['approve']);
    $condition = ['ID' => $id];
    $deleteMsg = approve_data($link, $condition,  $usrData, $usr);
    delete_data($link, "requests", $condition, $usrData, $usr);
    header("location:view.php");
}



function delete_data($db, $tableName, $condition, $usrData, $usr)
{
    $conditionData = '';
    $i = 0;
    ...
    if ($usrData[0] == "1") {
        ...
        $query = "DELETE FROM " . $tableName . " WHERE " . $conditionData . "AND username = \"$usr\"";
    }
...
function approve_data($db, $condition, $usrData, $usr)
{
    $conditionData = '';
    $i = 0;
    foreach ($condition as $index => $data) {
    ...
    if ($usrData[0] == "1") {
        ...
        $query = "INSERT INTO approvedRequests SELECT * FROM requests WHERE $conditionData";
    }
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active" style="padding: 0px 0px 0px 30px">
                <a class="nav-link">View Requests</a>
            </li>
            <?php
            if ($usrData[0] == "1") {
            ?>
    ...
    <table id="table" style="width:95%; margin-left: auto; margin-right: auto;">
        ...
        ?>
                    <tr style="background-color: #dddddd;">
                        ...
                        if ($usrData[0] == "1") {
                        ?>
                            <td><a href="view.php?delete=<?php echo $data['ID']; ?>" class="btn btn-danger">Deny</a>
                                <a href="view.php?approve=<?php echo $data['ID']; ?>" class="btn btn-success">Approve</a>
                            </td>
                        <?php } else { ?>
                            <td><a href="view.php?delete=<?php echo $data['ID']; ?>" class="btn btn-danger">Delete</a>
                            <?php } ?>
